...
module.exports = app => {
    ...
    router.put('/update/:id', isJsonRequestValid, getObjectOr404(userService), schemaValidation(updateUserSchema), controller.putUserUpdate);
    router.delete('/:id', getObjectOr404(userService), controller.deleteUser);
    app.use('/auth', router);
};